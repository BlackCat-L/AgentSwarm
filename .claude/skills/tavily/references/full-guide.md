...
# Script rewritten
Using Python stdlib (urllib) + direct REST API — no external packages needed.
```
...
The script uses only Python standard library (urllib). Just set TAVILY_API_KEY.
```
...
- Valid Tavily API key (`TAVILY_API_KEY` env var)

## Credits & Attribution

- Tavily API: https://tavily.com
- Python SDK: https://github.com/tavily-ai/tavily-python (not required, uses REST API directly)
